...
std::vector<std::string> m_Items = { "Toggle", "Hold on", "Hold off", "Always" };

bind_new::bind_new(int* m_Value, int* m_BindType)
{
	this->m_Value = m_Value;
	this->m_BindType = m_BindType;
}

void bind_new::UpdateList()
{
