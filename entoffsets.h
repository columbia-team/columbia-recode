...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_ragPos;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flPostponeFireReadyTime;
...
#define INIT_XOREDNETVAR_SPECIFIC( member_var, offset ) \
        ...
        INIT_XOREDNETVAR(m_flAccuracyPenalty, HASH("DT_WeaponCSBase"), HASH("m_fAccuracyPenalty"));
        ...
        INIT_XOREDNETVAR(m_ragPos, HASH("DT_Ragdoll"), HASH("m_ragPos"));
        ...
        INIT_XOREDNETVAR(m_flPostponeFireReadyTime, HASH("DT_WeaponCSBase"), HASH("m_flPostponeFireReadyTime"));
